...
<ol>
                    ...
                    <li id="global5">All boards on <a href="//www.4channel.org" target="_blank">4channel.org</a> are to be considered "work safe". Violators may be temporarily banned and their posts removed. Note: Spoilered pornography or other "not safe for work" content is NOT allowed.</li>
                    ...
                    <li id="global16">All request threads for adult content belong on /<a href="//boards.<?php echo L::d('r') ?>/r/" title="Request">r</a>/, and all request threads for work-safe content belong on /<a href="//boards.<?php echo L::d('wsr') ?>/wsr/" title="Worksafe Requests">wsr</a>/, unless otherwise noted.</li>
                  ...
                  Remember: The use of 4chan is a privilege, not a right. The 4chan moderation team reserves the right to revoke access and remove content for any reason without notice.</p>
<?
}

function right_box_title_1() {
?><a name="imgboard">Image Boards</a><?
}
...
<h3><a id="3" name="3">/3/ - 3DCG</a></h3>
                  ...
                  <ol>
                    ...
                    in /<a href="//boards.<?php echo L::d('jp') ?>/jp/">jp</a>/, and Western on /<a href="//boards.<?php echo L::d('vg') ?>/vg/">vg</a>/.</li>
                  ...
                  <ol>
                    ...
                    <li id="hc4">Requests belong in /<a href="//boards.<?php echo L::d('r') ?>/r/" title="Request">r</a>/!</li>
                  ...
                  <ol>
		            ...
		            /<a href="//boards.<?php echo L::d('hc') ?>/hc/" title="Hardcore">hc</a>/!</li>
                  ...
                  <ol>
                    ...
                    <li id="u2">Images must not contain men, and should ideally be of two or more women. The occasional solo image is allowed as long as it's relevant to the topic, but solo image dumps should be posted on /<a href="//boards.<?php echo L::d('e') ?>/e/" title="Ecchi">e</a>/.</li>
                  ...
                  <ol>
                    ...
                    in /<a href="//boards.<?php echo L::d('vg') ?>/vg/" title="Video Game Generals">vg</a>/. This is
                  ...
                  <ol>
                    ...
                    /<a href="//boards.<?php echo L::d('jp') ?>/jp/" title="Otaku Culture">jp</a>/. Translated visual novels
                  ...
                  <ol>
                    ...
                    <li id="vm3">"Generals"—long-term, recurring threads about a specific game—should be posted in /vg/. This is not to say threads about specific games cannot be created on /vm/, just that long-term, recurring threads belong in /vg/.</li>
                  ...
                  <ol>
                    ...
                    <li id="vmg3">"Generals"—long-term, recurring threads about a specific game—should be posted in /vg/. This is not to say threads about specific games cannot be created on /vmg/, just that long-term, recurring threads belong in /vg/.</li>
                  ...
                  <hr />
                  <h3><a id="vp" name="vp">/vp/ - Pok&eacute;mon</a></h3>
                  <ol>
                    ...
                    <li id="vp3">Post all Pok&eacute;girl hentai to /<a href="//boards.<?php echo L::d('h') ?>/h/" title="Hentai">h</a>/.</li>
                  ...
                  <ol>
                    ...
                    <li id="vrpg3">"Generals"—long-term, recurring threads about a specific game—should be posted in /vg/. This is not to say threads about specific games cannot be created on /vrpg/, just that long-term, recurring threads belong in /vg/.</li>
                  ...
                  <ol>
                    ...
                    <li id="vst3">"Generals"—long-term, recurring threads about a specific game—should be posted in /vg/. This is not to say threads about specific games cannot be created on /vst/, just that long-term, recurring threads belong in /vg/.</li>
...
?><a name="upboard">Upload Boards</a><?
}

function right_box_content_2() {
?>
<h3><a id="f" name="f">/f/ - Flash</a></h3>
                  <ol>
